...
export class UserManagementComponent implements OnInit, AfterViewInit {
  ...
  public roleFilterOptions: string[] = ['all', 'consumer', 'admin', 'supervisor', 'operators', 'call centers', 'reseller',
    'corporate', 'drivers'];
  public statusFilter = 'all';
  public statusFilterOptions: string[] = ['all', 'active', 'deactivated'];
  public users: any[];
  ...
  public roles: any[] = [];
  public columnsToDisplay: string[] = ['avatar', 'badge', 'name', 'status', 'actions'];
